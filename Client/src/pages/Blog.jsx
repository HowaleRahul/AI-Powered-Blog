  ...
  return data ? (
    <div className='relative'>
      ...
      <div className='text-center mt-20 text-gray-600'>
        ...
        <p className='inline-block py-1 px-4 rounded-full mb-6 border text-sm border-primary/35 bg-primary/5 font-medium text-primary'>Rahul Howale</p>
      </div>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <div className='max-w-3xl mx-auto'>
            ...
            <form onSubmit={addComment} className='flex flex-col items-start max-w-lg gap-4'>
              <input onChange = {(e) => setName(e.target.value)} value={name} type="text" name="" placeholder='Name' required className='w-full p-2 border border-gray-300 rounded outline-none'/>
              <textarea onChange = {(e) => setContent(e.target.value)} value={content} name="" className='w-full p-2 border border-gray-300 rounded outline-none h-48' laceholder='Comment' required></textarea>
